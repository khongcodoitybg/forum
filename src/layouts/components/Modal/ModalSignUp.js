...
function ModalSignUp({ isShowing, hide }) {
        ...
        <div className={cx('wrapper')}>
            ...
            <div className={cx('modal-body')}>
                ...
                <div className={cx('body')}>
                    <div className={cx('ifo-group')}>
                        <input type="text" className={cx('firstname-input')} placeholder="First name" />
                        <input type="text" className={cx('surname-input')} placeholder="Surname" />
                    </div>
